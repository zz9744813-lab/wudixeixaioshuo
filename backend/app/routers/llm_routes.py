...
async def list_route_configs(
    ...
    for config in configs:
        ...
        item = ProviderRouteConfigResponse(
            ...
            circuit_breaker_threshold=config.circuit_breaker_threshold or 5,
            circuit_breaker_reset_seconds=config.circuit_breaker_reset_seconds or 300,
            ...
            total_calls=(config.total_calls or 0),
            success_calls=(config.success_calls or 0),
            failed_calls=(config.failed_calls or 0),
            avg_latency_ms=(config.avg_latency_ms or 0),
